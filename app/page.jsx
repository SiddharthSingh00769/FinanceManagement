    ...
    <div className="mt-40">
      ...
      <section className="py-20 bg-blue-600 dark:bg-blue-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of users who are already managing their finances smartly with FinAura</p>
          <Link href="/dashboard">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-100 animate-bounce">Start a Free Trial</Button>
          </Link>
        </div>
      </section>
    </div>
